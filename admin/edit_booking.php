...
if (isset($_GET['id'])) {
    ...
    // Triển khai logic chỉnh sửa ở đây sử dụng $id cho đặt hàng cụ thể
    // Bạn có thể sử dụng ID này để truy xuất chi tiết đặt chỗ từ cơ sở dữ liệu và hiển thị chúng trong một biểu mẫu để chỉnh sửa
...
if (isset($_POST['save_changes'])) {
    ...
    // Triển khai logic cập nhật ở đây sử dụng $id cho đặt hàng cụ thể
    // Bạn có thể sử dụng ID này để cập nhật chi tiết đặt chỗ trong cơ sở dữ liệu
